...
Rails.application.config.x.company.accounting_phone = '(321) 499-1000'
Rails.application.config.x.company.accounting_email = 'accounting@fractel.net'
...
Rails.application.config.x.features.payments             = true
#
## Email
#
...
Rails.application.config.x.email.payment_sender       = 'accounting@fractel.net'
...
Rails.application.config.x.email.accounting_email     = 'accounting@fractel.net'
#
## Proposals
#
...
## Payments
#
Rails.application.config.x.payments.accepted = {
  'Stripe'      => :stripe,
  'SCCU'        => :bank_deposit,
  'Chase'       => :bank_deposit,
  'Wells Fargo' => :bank_deposit,
  'Intuit'      => :bank_deposit,
  'Credit'      => :credit,
}
